...
# initial_centroids
idx = findClosestCentroids.func(X, initial_centroids)
...
centroids, idx = runkMeans.func(X, initial_centroids, max_iters, 'True')
print('\nK-Means Done.\n\n')
...
X_recovered = np.zeros((idx.shape[0],centroids.shape[1]))
for k in range(idx.shape[0]):
    X_recovered[k,:] = centroids[int(idx[k]),:]
